...
if (!is_file("model/reportes/rReprobados.php")) {
    echo "Falta definir la clase del modelo: rReprobados.php";
    exit;
}
require_once("model/reportes/rReprobados.php");

if (is_file("views/reportes/rReprobados.php")) {
    ...
    $hayDatos = $reporteModel->verificarDatosReprobados();
    require_once("views/reportes/rReprobados.php");
} else {
