...
class Archivo extends Connection
{
    ...
    public function setAproCantidad($apro_cantidad)
    {
        $this->apro_cantidad = $apro_cantidad;
    }
    public function getAproCantidad()
    {
        return $this->apro_cantidad;
    }
    public function setPerCantidad($per_cantidad)
    {
        $this->per_cantidad = $per_cantidad;
    }
    public function getPerCantidad()
    {
    ...
    public function registrarAprobadosPer($archivo)
    {
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                $this->Con()->rollBack();
                $debug_info = "Año: " . $this->getAnioAnio() . ", Tipo: " . $this->getAnioTipo() . ", Fase: " . $this->fase_numero . ", UC: " . $this->getUcCodigo() . ", Sección: " . $this->getSecCodigo();
