...
class SeccionReport extends Connection
{
    ...
    public function getDistinctTimeSlotsForSeccion()
    {
        ...
        try {
            ...
            $stmt = $co->prepare($sql);
            $stmt->bindParam(':seccion_id_param', $this->seccion_id, PDO::PARAM_INT);
            $stmt->execute();
    ...
    public function getHorarioDataBySeccion()
    {
        ...
        try {
            ...
            $sql = "SELECT
                        ...
                        (SELECT GROUP_CONCAT(CONCAT(d.doc_nombre, ' ', d.doc_apellido) SEPARATOR '\n')
                         FROM tbl_docente d
                         JOIN uc_docente ud ON d.doc_cedula = ud.doc_cedula
                         WHERE ud.uc_codigo = uh.uc_codigo AND ud.uc_doc_estado = 1) AS NombreCompletoDocente
                    FROM
                        uc_horario uh
                    JOIN
                    ...
                    ORDER BY
                        uh.hor_horainicio ASC, u.uc_nombre ASC";
