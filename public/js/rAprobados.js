$(document).ready(function() {
    ...
    // Modificado para usar solo 2 colores
        ...
        myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: chartData.data,
                    backgroundColor: [
                        'rgba(75, 192, 192, 0.7)',  // Color para Aprobados Directo
                        'rgba(54, 162, 235, 0.7)'   // Color para Aprobaron PER
                    ],
                    borderColor: [
                        'rgba(75, 192, 192, 1)',
                        'rgba(54, 162, 235, 1)'
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Resultados Estudiantes (Aprobados Directo-Per)',
                        font: {
                            size: 16
                        }
                    }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    // Se calcula solo los aprobados directos y los que aprobaron el PER.
                    const aprobadosDirecto = totalEstudiantes - enPer;
                    // Se ha eliminado el cálculo de los que reprobaron el PER.

                    const chartData = {
                        // Se actualizan las etiquetas del gráfico.
                        labels: ['Aprobados Directo', 'Aprobaron PER'],
                        // Se actualizan los datos del gráfico para que coincidan.
                        data: [aprobadosDirecto, aprobadosPer]
                    };
    ...
    // Renderiza el gráfico vacío al cargar la página
    renderChart({
        labels: [],
        data: []
    });
