$(document).ready(function() {
    ...
    if (!hayDatos) {
        muestraMensaje('info', null, 'Sin Datos para Reportes', 'Actualmente no existen datos de PER registrados para generar un reporte. Por favor, vaya al módulo Resguardar Notas para ingresar los datos.');
    }
