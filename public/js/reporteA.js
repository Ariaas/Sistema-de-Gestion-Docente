$(document).ready(function() {
    ...
    if (!hayDatos) {
        muestraMensaje('info', null, 'Sin Datos para Reportes', 'Actualmente no existen aulas asignadas en el año activo para generar un reporte.');
    }
    ...
    function buildChartData(data) {
        ...
        let datasetLabel = 'Bloques Asignados';
    ...
    function getChartTitle(tipoReporte) {
        if (tipoReporte === 'aulas_distribucion') return 'Distribución de Uso de Aulas (Todas)';
        if (tipoReporte === 'aulas_top10') return 'Top 10 Aulas Más Usadas';
        if (tipoReporte === 'aulas_top5') return 'Top 5 Aulas Más Usadas';
        if (tipoReporte === 'aula_mas_usada') return 'Aula Más Usada';
