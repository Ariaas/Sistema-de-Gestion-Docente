$(document).ready(function() {
    ...
    function buildChartData(data) {
        ...
        let datasetLabel = 'Aulas Asignadas';
    ...
    function getChartTitle(tipoReporte) {
        if (tipoReporte === 'dias_distribucion') return 'Distribución de Aulas Asignadas por Día';
        if (tipoReporte === 'dias_top3') return 'Top 3 Días con Más Aulas Asignadas';
        if (tipoReporte === 'dia_mas_asignado') return 'Día con Más Aulas Asignadas';
