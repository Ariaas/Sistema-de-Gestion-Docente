    ...
    <main class="main-content flex-shrink-0">
        <section class="d-flex flex-column align-items-center justify-content-center py-4">
            ...
            <div class="w-100 d-flex justify-content-end mb-3" style="max-width: 1100px;">
                <button class="btn btn-success px-4" id="btnSubir">Subir Archivo</button>
            </div>
            
            <div class="datatable-ui w-100" style="max-width: 1100px; margin: 0 auto 2rem auto; padding: 1.5rem 2rem;">
                <div class="table-responsive" style="overflow-x: hidden;">
                    <table class="table table-striped table-hover w-100" id="tablaArchivos">
                        <thead>
                            <tr>
                                <th>Nombre</th>
                                <th>Acciones</th>
                    ...
                    <div class="modal-body">
                        <form id="formArchivo" enctype="multipart/form-data" class="needs-validation" novalidate>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" class="form-control" name="archivo" accept=".pdf,.doc,.docx,.txt" required>
                            </div>
