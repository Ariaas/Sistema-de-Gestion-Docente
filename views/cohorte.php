...
<body class="d-flex flex-column min-vh-100">
        ...
        <section class="d-flex flex-column align-items-center justify-content-center py-4">
            ...
            <div class="datatable-ui w-100" style="max-width: 1100px; margin: 0 auto 2rem auto; padding: 1.5rem 2rem;">
                <div class="table-responsive" style="overflow-x: hidden;">
                    <table class="table table-striped table-hover w-100" id="tablacohorte">
                        <thead>
                            <tr>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title">Formulario de Cohortes</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form method="post" id="f" autocomplete="off" class="needs-validation" novalidate>
                            <input type="hidden" name="accion" id="accion">
                            <input type="hidden" id="cohId" name="cohId">

                            <div class="mb-4">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label for="cohNumero" class="form-label">Numero de la cohorte</label>
                                        <input class="form-control" type="text" id="cohNumero" name="cohNumero" required>
                                        <span id="scohNumero" class="form-text"></span>
                                    </div>
                                </div>
                            </div>
    ...
    ?>
    <script type="text/javascript" src="public/js/cohorte.js"></script>
