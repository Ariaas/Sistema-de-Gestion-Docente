            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <div class="col">
                    <a class="a-cards" href="?pagina=espacios">
                        <div class="card h-100 text-center custom-card card-docentes">
                            <div class="card-body">
                                <img src="public/assets/icons/book-svgrepo-com.svg" class="card-icon" style="width: 1.5em; height: 1.5em; fill: currentColor;" alt="Book Icon">
                ...
                <div class="col">
                    <a class="a-cards" href="?pagina=seccion">
                        <div class="card h-100 text-center custom-card card-docentes">
                            <div class="card-body">
                                <img src="public/assets/icons/book.svg" class="card-icon" style="width: 1.5em; height: 1.5em; fill: currentColor;" alt="Book Icon">
                ...
                <div class="col">
                    <a class="a-cards" href="?pagina=trayecto">
                        <div class="card h-100 text-center custom-card card-docentes">
                            <div class="card-body">
                                <img src="public/assets/icons/calendar.svg" class="card-icon" style="width: 1.5em; height: 1.5em; fill: currentColor;" alt="Calendar Icon">
                ...
                <div class="col">
                    <a class="a-cards" href="?pagina=mallacurricular">
                        <div class="card h-100 text-center custom-card card-docentes">
                            <div class="card-body">
                                <img src="public/assets/icons/gear.svg" class="card-icon" style="width: 1.5em; height: 1.5em; fill: currentColor;" alt="Gear Icon">
