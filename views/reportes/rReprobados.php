...
<head>
    ...
    <title>Reporte Estadístico - Reprobados en PER</title>
</head>
...
<body class="d-flex flex-column min-vh-100" data-hay-datos="<?php echo $hayDatos ? 'true' : 'false'; ?>">
    ...
    <main class="main-content flex-shrink-0">
        <section class="d-flex flex-column align-items-center justify-content-center py-4 px-3">
            <h2 class="text-primary text-center mb-4" style="font-weight: 600; letter-spacing: 1px;">Estudiantes Reprobados en PER</h2>
    ...
    <script type="text/javascript" src="public/js/rReprobados.js"></script>
