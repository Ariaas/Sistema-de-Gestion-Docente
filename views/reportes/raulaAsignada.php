                ...
                <form method="post" action="" id="fReporteAsignacionAulas" target="_blank">
                    <div class="row g-3 mb-4">
                        <div class="col-12 col-sm-6 col-md-6">
                            ...
                            <select class="form-select form-select-sm" id="anio_completo" name="anio_completo" required>
                        ...
                        <div class="col-12 col-sm-6 col-md-6" id="fase_container">
                            ...
                            <select class="form-select form-select-sm" id="fase_id" name="fase_id" required>
