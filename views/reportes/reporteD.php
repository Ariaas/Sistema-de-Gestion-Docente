...
<head>
    ...
    <title>Reporte Estadístico de Horas Docentes</title>
</head>
...
<body class="d-flex flex-column min-vh-100" data-hay-datos="<?php echo $hayDatos ? 'true' : 'false'; ?>">
    ...
    <main class="main-content flex-shrink-0">
        <section class="d-flex flex-column align-items-center justify-content-center py-4 px-3">
            <h2 class="text-primary text-center mb-4" style="font-weight: 600; letter-spacing: 1px;">Reporte Estadístico de Horas Docentes</h2>
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-6 mb-3">
                                ...
                                <select class="form-select" id="tipo_reporte" name="tipo_reporte">
                                    <option value="docente_distribucion" selected>Distribución de Horas</option>
                                    <option value="docente_mayor_a_diez">Docentes con > 10 Horas</option>
                                </select>
                            </div>
                            <div class="col-lg-4 col-md-6 mb-3">
