...
<head>
    ...
    <title>Reporte de Horario Docente</title>
</head>
            ...
            <div class="card p-4 shadow-sm bg-light rounded">
                <form method="post" action="" id="fReporteHorDocente" target="_blank">
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <label for="cedula_docente" class="form-label">Docente: <span style="color: red;">*</span></label>
                            <select class="form-select form-select-sm" name="cedula_docente" id="cedula_docente" required>
