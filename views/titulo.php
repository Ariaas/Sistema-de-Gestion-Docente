...
<body>
    ...
    <main class="main-content">
        <section class="d-flex flex-column align-items-md-center" style="margin-top: 110px;">
            <center>
                <h2 class="text-primary text-md-center">Gestionar Titulos</h2>
            </center>
            <br>
            <div class="container">
            ...
            <div class="container card shadow mb-4 "> <!-- todo el contenido ira dentro de esta etiqueta-->
                ...
                <div class="container text-md-center">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover" id="tablatitulo">
                            <thead>
                                <tr>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Formulario de Titulos</h5>
                            ...
                            <div class="container">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4" style="display: none;">
                                        ...
                                        <input class="form-control" type="text" id="tituloid" name="tituloid" min="1">
                                        <span id="stituloid"></span>
                                    </div>

                                    <div class="col-md-4">
                                        <label for="tituloprefijo">tipo(prefijo)</label>
                                        <select class="form-select" name="tituloprefijo" id="tituloprefijo">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control" type="text" id="titulonombre" name="titulonombre" >
