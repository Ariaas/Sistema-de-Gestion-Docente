                            ...
                            <div class="mb-4">
                                <div class="row g-3">
                                    <div class="col-md-4" style="display: none;">
                                        <label for="turnoid">ID</label>
                                        <input class="form-control" type="text" id="turnoid" name="turnoid">
                                        <span id="sturnoid"></span>
                                    </div>
                                   
                                    <div class="col-md-6">
                                        <label for="horaInicio" class="form-label">Hora de inicio</label>
                                        <input class="form-control" type="time" id="horaInicio" name="horaInicio" required>
                                        <span id="shoraInicio"></span>
                                    </div>
                                     <div class="col-md-6">
                                        <label for="horafin" class="form-label">Hora de fin</label>
                                        <input class="form-control" type="time" id="horafin" name="horafin" required>
                                        <span id="shorafin"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn btn-primary me-2" id="proceso">REGISTRAR</button>
